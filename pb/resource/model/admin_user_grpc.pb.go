...
const (
	AdminUser_ShowOneByName_FullMethodName = "/pb.resource.model.AdminUser/ShowOneByName"
)
...
type AdminUserClient interface {
	ShowOneByName(ctx context.Context, in *OneAdminUserRequest, opts ...grpc.CallOption) (*OneAdminUerResponse, error)
}
...
func (c *adminUserClient) ShowOneByName(ctx context.Context, in *OneAdminUserRequest, opts ...grpc.CallOption) (*OneAdminUerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OneAdminUerResponse)
	err := c.cc.Invoke(ctx, AdminUser_ShowOneByName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminUserServer interface {
	ShowOneByName(context.Context, *OneAdminUserRequest) (*OneAdminUerResponse, error)
...
func (UnimplementedAdminUserServer) ShowOneByName(context.Context, *OneAdminUserRequest) (*OneAdminUerResponse, error) {
...
func _AdminUser_ShowOneByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OneAdminUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminUserServer).ShowOneByName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminUser_ShowOneByName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminUserServer).ShowOneByName(ctx, req.(*OneAdminUserRequest))
	}
...
var AdminUser_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.resource.model.AdminUser",
	HandlerType: (*AdminUserServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ShowOneByName",
			Handler:    _AdminUser_ShowOneByName_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "resource/model/admin_user.proto",
}
