...
const file_facade_admin_authentication_authenticator_proto_rawDesc = "" +
	"\n" +
	"/facade/admin/authentication/authenticator.proto\x12\x1epb.facade.admin.authentication\"<\n" +
	"\n" +
	"OneRequest\x12\x12\n" +
	...
	"\vOneResponse2r\n" +
	"\rAuthenticator\x12a\n" +
	"\x06SignIn\x12*.pb.facade.admin.authentication.OneRequest\x1a+.pb.facade.admin.authentication.OneResponseB\"Z ./pb_facade_admin_authenticationb\x06proto3"
...
var file_facade_admin_authentication_authenticator_proto_depIdxs = []int32{
	0, // 0: pb.facade.admin.authentication.Authenticator.SignIn:input_type -> pb.facade.admin.authentication.OneRequest
	1, // 1: pb.facade.admin.authentication.Authenticator.SignIn:output_type -> pb.facade.admin.authentication.OneResponse
